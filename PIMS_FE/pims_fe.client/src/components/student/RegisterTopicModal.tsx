                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value={topicName}
                            onChange={(e) => { setTopicName(e.target.value); setErrors(p => ({ ...p, topicName: undefined })); }}
                            placeholder="Enter topic name..."
                            disabled={loading}
                            className={`w-full px-4 py-3 border rounded-xl text-sm outline-none transition-all focus:ring-2 focus:ring-primary/30 ${
                                errors.topicName ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-primary'
                            }`}
                        />
                        {errors.topicName && <p className="text-red-500 text-xs mt-1.5">{errors.topicName}</p>}
                    </div>
