                ...
                <main className="flex-1 flex flex-col overflow-y-auto">
                    ...
                    <header className="sticky top-0 z-10 flex items-center justify-between bg-white border-b border-gray-200 px-8 py-4">
                        <div className="flex items-center gap-4">
                            <h2 className="text-xl font-bold text-gray-900">Project Dashboard</h2>
                        </div>
                    ...
                    <div className="p-8 max-w-7xl mx-auto w-full flex flex-col gap-8">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                            ...
                            <div className="lg:col-span-3 flex flex-col gap-6">
                                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div className="p-4 border border-gray-100 rounded-xl flex items-center gap-4 hover:shadow-md transition">
                                            ...
                                            ></div>
                                            <div>
                                                <p className="font-bold text-sm text-gray-900">Sarah Chen</p>
                                        ...
                                        <div className="p-4 border border-gray-100 rounded-xl flex items-center gap-4 hover:shadow-md transition">
                                            ...
                                            ></div>
                                            <div>
                                                <p className="font-bold text-sm text-gray-900">Marcus Wu</p>
                                ...
                                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                                    <h4 className="font-bold text-lg text-gray-900 mb-6">Milestones &amp; Reports</h4>
                                    <div className="space-y-6 relative before:content-[''] before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-[2px] before:bg-gray-100">
                                        ...
                                        <div className="relative pl-8">
                                            ...
                                            <div className="flex justify-between items-start">
                                                <div>
                                                    <p className="font-bold text-gray-900">Requirement Specification</p>
                                        ...
                                        <div className="relative pl-8">
                                            ...
                                            <div className="flex justify-between items-start">
                                                <div>
                                                    <p className="font-bold text-gray-900">Architecture &amp; Design</p>
                                                    <p className="text-sm text-gray-500">PR #02 Due: Oct 15, 2023</p>
                                                </div>
                                        ...
                                        <div className="relative pl-8">
                                            ...
                                            <div className="flex justify-between items-start">
                                                <div>
                                                    <p className="font-bold text-gray-900">Mid-term Demo</p>
                                                    <p className="text-sm text-gray-500">PR #03 Due: Oct 24, 2023</p>
                                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="p-4 bg-gray-50 rounded-lg">
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            ></div>
                                            <p className="text-xs font-bold text-gray-700">Prof. Miller</p>
                                            <span className="text-[10px] text-gray-400">2h ago</span>
                                        </div>
                                        <p className="text-sm text-gray-600">
                                            "Excellent progress on the API documentation. Make sure to include the
                                            OAuth2 flow in the next update."
                                        </p>
                                    </div>
                                    {/* Comment 2 */}
                                    <div className="p-4 bg-gray-50 rounded-lg">
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            ></div>
                                            <p className="text-xs font-bold text-gray-700">TA Jessica</p>
                                            <span className="text-[10px] text-gray-400">1d ago</span>
                                        </div>
                                        <p className="text-sm text-gray-600">
                                            "Please update the Gantt chart in the repository. The design phase seems
                                    ...
                                    <div className="p-4 bg-gray-50 rounded-lg">
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            ></div>
                                            <p className="text-xs font-bold text-gray-700">Prof. Miller</p>
                                            <span className="text-[10px] text-gray-400">3d ago</span>
                                        </div>
                                        <p className="text-sm text-gray-600">
                                            "Requirement document approved. Good breakdown of user stories."
                                        </p>
                                    </div>
