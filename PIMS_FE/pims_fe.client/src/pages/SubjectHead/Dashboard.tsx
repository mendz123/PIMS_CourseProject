            ...
            <aside className="w-64 border-r border-[#dbdfe6] bg-white flex flex-col fixed h-full z-20">
                <div className="p-6 flex flex-col gap-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-[#111318] text-base font-bold leading-none">PIMS Dashboard</h1>
                ...
                <header className="h-16 bg-white border-b border-[#dbdfe6] px-8 flex items-center justify-between sticky top-0 z-10">
                    <div className="flex items-center gap-4">
                        <div className="flex flex-wrap gap-2">
                            <a className="text-[#616f89] text-sm font-medium hover:text-primary transition-colors" href="#">
                                Dashboard
                            </a>
                            <span className="text-[#616f89] text-sm">/</span>
                            <span className="text-[#111318] text-sm font-bold">Subject Overview</span>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
                        ...
                        <button className="p-2 rounded-lg bg-[#f6f6f8] text-[#616f89] hover:bg-primary/10 hover:text-primary transition-all">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-white p-6 rounded-xl border border-[#dbdfe6] shadow-sm">
                            <div className="flex justify-between items-start mb-4">
                                <p className="text-[#616f89] text-sm font-medium">Subject Success Rate</p>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-[#dbdfe6] shadow-sm">
                            <div className="flex justify-between items-start mb-4">
                                <p className="text-[#616f89] text-sm font-medium">Avg. Feedback Time</p>
                                <span className="bg-red-100 text-red-700 text-[10px] px-2 py-0.5 rounded-full font-bold">
                                    -0.5%
                                </span>
                            </div>
                            <div className="flex items-baseline gap-2">
                                <h3 className="text-3xl font-bold text-[#111318]">2.4 Days</h3>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-[#dbdfe6] shadow-sm border-l-4 border-l-amber-500">
                            <div className="flex justify-between items-start mb-4">
                                <p className="text-[#616f89] text-sm font-medium">Pending Audits</p>
                            ...
                            <div className="flex items-baseline gap-2">
                                ...
                                <span className="text-[#616f89] text-xs">Requires Action</span>
                            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1 bg-white rounded-xl border border-[#dbdfe6] overflow-hidden shadow-sm">
                            <div className="p-5 border-b border-[#dbdfe6] bg-slate-50 flex justify-between items-center">
                                <h2 className="font-bold text-[#111318] text-base">Master Assessment Schema</h2>
                                <button className="text-primary text-xs font-bold hover:underline">Edit Weights</button>
                            </div>
                            <div className="p-5 flex flex-col gap-4">
                                <div className="flex items-center justify-between group">
                                    <div className="flex items-center gap-3">
                                        <span className="material-symbols-outlined text-slate-400">article</span>
                                        <span className="text-sm text-[#111318]">Final Examination</span>
                                    </div>
                                ...
                                <div className="flex items-center justify-between group">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm text-[#111318]">Capstone Project</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                ...
                                <div className="flex items-center justify-between group">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm text-[#111318]">Group Presentation</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                ...
                                <div className="flex items-center justify-between group border-b border-dashed border-[#dbdfe6] pb-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm text-[#111318]">Periodic Quizzes</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                        ...
                        <div className="lg:col-span-2 bg-white rounded-xl border border-[#dbdfe6] shadow-sm overflow-hidden">
                            <div className="p-5 border-b border-[#dbdfe6] flex justify-between items-center">
                                <div>
                                    ...
                                    <p className="text-xs text-[#616f89]">Comparison of Semester 1 2024 results</p>
                                </div>
                                ...
                                <div className="flex-1 flex flex-col items-center gap-2">
                                    <div className="w-full bg-primary/20 rounded-t-lg relative group h-[180px]">
                                        <div
                                            ...
                                            style={{ height: "160px" }}
                                        ></div>
                                        <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] font-bold text-primary opacity-0 group-hover:opacity-100">
                                            88%
                                        </span>
                                    </div>
                                    <span className="text-[10px] text-[#616f89] font-bold">SEC-01</span>
                                </div>
                                <div className="flex-1 flex flex-col items-center gap-2">
                                    <div className="w-full bg-primary/20 rounded-t-lg relative group h-[180px]">
                                        <div
                                    ...
                                    <span className="text-[10px] text-[#616f89] font-bold">SEC-02</span>
                                </div>
                                <div className="flex-1 flex flex-col items-center gap-2">
                                    <div className="w-full bg-primary/20 rounded-t-lg relative group h-[180px]">
                                        <div
                                            ...
                                            style={{ height: "110px" }}
                                        ></div>
                                        <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] font-bold text-amber-600 opacity-0 group-hover:opacity-100">
                                            62%
                                        </span>
                                    </div>
                                    <span className="text-[10px] text-[#616f89] font-bold">SEC-03</span>
                                </div>
                                <div className="flex-1 flex flex-col items-center gap-2">
                                    <div className="w-full bg-primary/20 rounded-t-lg relative group h-[180px]">
                                        <div
                                    ...
                                    <span className="text-[10px] text-[#616f89] font-bold">SEC-04</span>
                                </div>
                                <div className="flex-1 flex flex-col items-center gap-2">
                                    <div className="w-full bg-primary/20 rounded-t-lg relative group h-[180px]">
                                        <div
                                    ...
                                    <span className="text-[10px] text-[#616f89] font-bold">SEC-05</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table className="w-full text-left">
                                    ...
                                    <tbody className="divide-y divide-[#dbdfe6]">
                                        ...
                                        <tr className="hover:bg-slate-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4">
                                                <span className="text-sm text-red-500 font-bold">5.2 Days</span>
                                            </td>
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2">
                                        ...
                                        <tr className="hover:bg-slate-50 transition-colors">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <span className="text-sm font-medium text-[#111318]">Robert K.</span>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
                                                <span className="bg-slate-100 px-2 py-1 rounded text-[10px] font-bold uppercase">
                                            ...
                                            <td className="px-6 py-4">
                                                <span className="text-sm">3.1 Days</span>
                                            </td>
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2">
                                                    <span className="px-2 py-0.5 rounded-full bg-green-100 text-green-700 text-[10px] font-bold">
                        ...
                        <div className="xl:col-span-1 flex flex-col gap-6">
                                ...
                                <div className="p-4 flex flex-col gap-4">
                                    <div className="p-3 bg-red-50 rounded-lg border border-red-100">
                                        <div className="flex justify-between mb-1">
                                            <p className="text-[10px] font-bold text-red-700">HIGH VARIANCE</p>
                                    ...
                                    <div className="p-3 bg-amber-50 rounded-lg border border-amber-100">
                                        <div className="flex justify-between mb-1">
                                            <p className="text-[10px] font-bold text-amber-700">LATE APPROVAL</p>
                                            <span className="text-[10px] text-slate-400">5h ago</span>
                                        </div>
                                        <p className="text-xs text-slate-700 font-medium">
                                            3 Project Specifications in SEC-05 awaiting signature.
                                        </p>
                                        <button className="mt-2 text-[10px] font-bold text-primary flex items-center gap-1">
                                            Approve Now{" "}
                                            <span className="material-symbols-outlined text-[10px]">arrow_outward</span>
                            ...
                            <div className="bg-primary p-5 rounded-xl text-white shadow-lg shadow-primary/20 flex flex-col gap-3 relative overflow-hidden">
                                <div className="relative z-10">
                                    <h3 className="font-bold text-sm">Upcoming Subject Audit</h3>
                                    <p className="text-xs text-white/80 mt-1">
                                        External moderation begins in 14 days. Ensure all schemas are locked.
                                    </p>
                                    <button className="mt-4 bg-white text-primary text-[10px] font-bold px-4 py-2 rounded-lg">
