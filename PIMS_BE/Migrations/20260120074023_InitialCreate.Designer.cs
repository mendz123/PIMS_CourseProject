...
namespace PIMS_BE.Migrations
{
    ...
    [Migration("20260120074023_InitialCreate")]
            ...
            modelBuilder.Entity("PIMS_BE.Models.CouncilCriteriaGrade", b =>
                {
                    ...
                    b.HasKey("GradeId")
                        .HasName("PK__CouncilC__54F87A57DCDC8610");

                    b.HasIndex("CriteriaId");

                    b.HasIndex("TeacherId");

                    b.HasIndex(new[] { "GroupId" }, "IX_CouncilGrades_Group");

                    b.HasIndex(new[] { "CouncilId", "GroupId", "TeacherId", "CriteriaId" }, "UQ_Council_Grade")
                        .IsUnique();
