...
public interface IAssessmentService
{
    ...
    Task<List<AssessmentDto>> GetAssessmentsBySemesterAsync(int semesterId, bool includeRetake = false);
    Task<AssessmentWithCriteriaDto?> GetAssessmentWithCriteriaAsync(int assessmentId);
    Task<List<AssessmentWithCriteriaDto>> GetAssessmentsWithCriteriaAsync(int semesterId, bool includeRetake = false);
